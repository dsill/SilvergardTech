...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'AngeionCalcs - Insert & Update Lookup Values', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Insert & Update Lookups from Excel]    Script Date: 12/5/2016 3:17:23 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Insert & Update Lookups from Excel', 
		@step_id=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Every 10 Minutes', 
		...
		@schedule_uid=N'1c977b22-c73e-4026-ba30-e31b37fde00c'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
